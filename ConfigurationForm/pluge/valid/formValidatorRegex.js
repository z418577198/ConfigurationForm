...
function checkName(){
		var logName = encode64(document.getElementById("logName").value);
	    document.getElementById("logName").value = logName;
	    var password = encode64(document.getElementById("passwordId").value);
	    document.getElementById("passwordId").value = password;
	    var password = encode64(document.getElementById("password_confirmation").value);
